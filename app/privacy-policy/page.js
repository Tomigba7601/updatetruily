...
const Privacy = () => {
  return (
    <div className="flex flex-col py-10">
      <Container>
        <h2 className="font-bold text-2xl mb-8">Privacy Policy</h2>
        <p className="font-bold mb-3">Welcome to the Truily Privacy Policy </p>
        <p className="mb-3">
          We are Vibings Inc. We offer our Truily mobile app, Truily desktop
          app, and their associated services, websites, and microsites (such as
          www.truily.com) under the Truily brand (collectively “our app”). Your
          privacy is important to us. It is Vibings Inc.'s policy to respect
          your privacy and comply with any applicable law or regulation
          regarding any personal information we may collect about you, including
          via our app. Some of our services may require their own unique privacy
          policy. If a service has its own privacy policy, then that policy will
          apply rather than this Privacy Policy.
        </p>
        <p className="mb-3">
          Vibings Inc. is the company responsible for your information under
          this Privacy Policy:
        </p>
        <p className="mb-3">
          Vibings Inc.<br></br>
          1030 Shelton Road, Suite #203<br></br>
        ...
        <p className="mb-3">
          ...
          apply to any of your activities after you leave our app.
        </p>
        <p className="mb-3 font-bold">
          International Transfers of Personal Information
        </p>
        <p className="mb-3">
          Our app is offered globally. Regardless of the country you reside int,
          ...
          third-party providers maintain facilities. This Privacy Policy
          explains how we protect your personal data when it may transferred
          from one country to another, so please read this Privacy Policy very
          carefully.
        </p>
        <p className="mb-3">
        ...
        <p className="mb-3">Last updated: 11 December 2023</p>
        <p className="mb-3 font-bold">Information We Collect</p>
        <p className="mb-3">
          We want to help you develop meaningful personal connections. So we
          need to gather some information about you, such as basic profile
          details, the types of relationships you prefer, and the types of
          people you&apos;d like to meet.
        </p>
        <p className="mb-3 font-bold">Collection and Use of Information</p>
        <p className="mb-3">
        ...
        <p className="mb-3">Information generated when you use our services</p>
        <p className="mb-3">
        ...
        <p className="mb-3 font-bold">Usage Information</p>
        <p className="mb-3">
          ...
          usage. Using the services generates data about your activity on our
          services, for instance how you use them (for example, when you logged
          in, features you&apos;ve been using, actions taken, information shown
          to you, referring webpages address and ads that you interacted with)
          and your interactions with other users (for example, users you connect
          and interact with, when you exchanged with them, and number of
        ...
        <p className="mb-3 font-bold">Device Information</p>
        <p className="mb-3">
          ...
          you can reset by going into your device&apos;s settings), identifiers
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-700 mb-4">
            ...
            such as IP address, device ID and type, app settings and
            characteristics, app crashes, advertising IDs (randomly generated
            numbers that you can reset in your device&apos;s settings), and
          ...
          <p className="text-gray-700 mb-4">
            ...
            app, we request permission to access this information. The specific
            data we collect can depend on the individual settings of your device
            and the permissions you grant when you install and use the app. For
            example, if you give us permission, we can collect your precise
            geolocation (latitude and longitude). The collection of your
            ...
            precise geolocation, we will not collect it.
          </p>
        </section>
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-4">Sensitive Information</h2>
          <p className="text-gray-700 mb-4">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-600 mb-4">
            ...
            <li>Sexual practices or sex life</li>
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-700 mb-4">
            ...
            the purpose of publication on our platform, website, or
            re-publishing on our social media channels. For example, you may
            voluntarily supply your photos and videos to us when you publish a
            photo or video or participate in streaming features on our services.
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-700 mb-4">
            ...
            legitimate reason for doing so. For instance, we collect personal
            information that is reasonably necessary to provide our services to
            you. For example, to ensure safety and authenticity, we request
            photo verification to avoid the creation of fake accounts and to
            prevent fraud. This is voluntary; if you choose to participate in
            our photo verification feature, we collect your face geometry data,
            which may be considered biometric data in some jurisdictions, to
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-700 mb-4">
            If we receive personal information about you from others (“third
            parties”), we will protect it as outlined in this Privacy Policy. If
            you are a third party providing personal information about somebody
            else, you represent and warrant that you have such person&apos;s
            consent to provide the information to us.
          </p>
          <p className="text-gray-700 mb-4">
            The information about you we may receive from others includes:
          </p>
          <ul className="list-disc list-inside space-y-2 text-gray-600 mb-4">
            <li>
              <strong>Users:</strong> Users may provide information about you as
              they use our services, for instance, as they interact with you or
              if they submit a report involving you.
            </li>
            <li>
              <strong>Social Media:</strong> We may receive information about
              you from your social media providers, such as Instagram® or
              Spotify®. This may occur if you decide to share information with
              us through your social media account.
            </li>
            <li>
              <strong>Other Partners:</strong> We may receive information about
              you from our partners. For instance, when Truily ads are published
              on a partner&apos;s service, they may pass along details about you
              included in the data of the advertising campaign.
            </li>
          </ul>
        </section>

        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-4">Purchases Information</h2>
          <p className="text-gray-700 mb-4">
          ...
          <p className="text-gray-700 mb-4">
            If you decide to purchase any of our premium services or add-ons
            using our app, desktop version, or website, we will process your
            payment information and retain this securely for the prevention of
            fraud and for audit/tax purposes. [Note: We hope to use a
            third-party service to process payments and retain payment
            information.]
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-700 mb-4">
            ...
            account, we may retain this information for the duration your
            account exists on our system. If your personal information is no
          ...
          <p className="text-gray-700 mb-4">
            ...
            compliance with legal, accounting, or reporting obligations, or for
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-700 mb-4">
            ...
            personal information about individuals under 18.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-600 mb-4">
            ...
            <li>
              third-party service providers for purposes including IT services,
              data storage, hosting, server, advertising, analytics, and payment
              systems
            </li>
            ...
            <li>
              ...
              authorities, in the event of unpaid goods or services
            </li>
            <li>
              courts, tribunals, regulatory authorities, and law enforcement
              officers, as required by law or to establish legal rights
            </li>
            <li>
              third parties assisting us in providing information, products,
              services, or direct marketing to you
            </li>
            <li>entities that acquire our assets or business</li>
          </ul>
          <p className="text-gray-700 mb-4">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-600 mb-4">
            <li>
              <strong>Billing services:</strong> To allow customers to purchase
              paid features (e.g., Google Play, Apple Pay, PayPal, and Stripe)
            </li>
            <li>
              <strong>Authentication services:</strong> To authenticate accounts
              (e.g., Twilio)
            </li>
            <li>
              <strong>Social media providers:</strong> To connect accounts
              (e.g., Instagram or Spotify)
            </li>
            <li>
              <strong>
                Product improvement and market research providers:
              </strong>{" "}
              To improve products and services (e.g., Google Analytics)
            </li>
            <li>
              <strong>Marketing service providers:</strong> To market and
              advertise (e.g., Facebook and Google Adsense)
            </li>
            <li>
              <strong>CampaignMonitor:</strong> To create custom audiences using
              a hashed version of your email address
            </li>
          </ul>
        </section>
        <section className="mb-6">
        ...
        <section className="mb-6">
          <h2 className="text-xl font-semibold mb-2">Marketing permission:</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-6">
          <h2 className="text-xl font-semibold mb-2">Non-discrimination:</h2>
          <p className="text-gray-700">
            ...
            offer (for example serving particular content to your device), we
        ...
        <section className="mb-6">
          <h2 className="text-xl font-semibold mb-2">Unsubscribe:</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-6">
          <h2 className="text-xl font-semibold mb-2">Use of Cookies:</h2>
          <p className="text-gray-700">
            ...
            the app servers to recognize your device when you use the app;
            information about your account, session and/or device; additional
            data that serves the purpose of the cookie; and any self-maintenance
            information about the cookie itself.
          </p>
          <p className="text-gray-700 mt-2">
            We use cookies to give your device access to core features of our
            app, to track app usage and performance on your device, to tailor
            your experience of our app based on your preferences, and to serve
          ...
          <p className="text-gray-700 mt-2">
            Please refer to our Cookie Policy at [link required] for more
            information.
          </p>
        </section>

        <section className="mb-6">
          <h2 className="text-xl font-semibold mb-2">Business Transfers:</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-6">
          <h2 className="text-xl font-semibold mb-2">Limits of Our Policy:</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-700">
            <strong>Data Controller / Data Processor:</strong> The GDPR
            distinguishes between organizations that process personal
            ...
            organizations (known as "data processors"). We, Vibings Inc.,
          ...
          <p className="text-gray-700 mt-2">
            ...
            them. This means that we may collect and use your personal
            information only when we have one or more of the following legal
            bases:
          </p>
          <ul className="list-disc ml-5 text-gray-700">
            <li>
              To perform a contract with you (e.g., to provide you with services
              you requested)
            </li>
            <li>
              To comply with our legal obligations (e.g., to meet legal or
              regulatory requirements)
            </li>
            <li>
              To protect your vital interests (e.g., in emergency situations)
            </li>
            <li>
              To perform tasks carried out in the public interest (e.g., to
              fulfill a role that benefits the community)
            </li>
            <li>With your consent (e.g., for direct marketing purposes)</li>
            <li>
              To pursue our legitimate interests (e.g., for the improvement of
              our services and business processes)
            </li>
          </ul>
          <p className="text-gray-700 mt-2">
            <strong>Data Subject Rights:</strong> Under the GDPR, you have
          ...
          <ul className="list-disc ml-5 text-gray-700">
            ...
            <li>
              Withdraw your consent where our processing is based on your
              consent
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc ml-5 text-gray-700">
            <li>
              ...
              collect and use your personal information for a specific purpose.
              You may withdraw your consent at any time using the facilities we
              provide; however this will not affect any use of your information
            ...
            <li>
              ...
              contract or transaction with you. For example, we need technical
              information about your device in order to provide the essential
              features of our app.
            </li>
            <li>
              <strong>Our Legitimate Interests:</strong> Where we assess it is
              necessary for our legitimate interests, such as for us to provide,
              operate, improve and communicate our services. For example, we
              collect technical information about your device in order to
              improve and personalize your experience of our app.
            </li>
            <li>
              <strong>Compliance with Law:</strong> In some cases, we may have a
              legal obligation to use or keep your personal information. Such
              cases may include (but are not limited to) court orders, criminal
              investigations, government requests, and regulatory obligations.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mt-2">
            ...
            from our current records. There may be exceptions to this right for
            specific legal reasons which, if applicable, we will set out for you
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700">
            ...
            feature that lets you tell websites that you do not want to have
            your online activities tracked. At this time, we do not respond to
            browser "Do Not Track" signals.
          </p>
          <p className="text-gray-700 mt-2">
            <strong>Cookies and Pixels:</strong> At all times, you may decline
            cookies from our site if your browser permits. Most browsers allow
            you to activate settings on your browser to refuse the setting of
            all or some cookies. Please refer to the Cookies section of this
            Privacy Policy for more information.
          </p>
          <p className="text-gray-700 mt-2">
            <strong>California Privacy Laws - CPPA:</strong> Under California
            Civil Code Section 1798.83, if you live in California and your
            business relationship with us is mainly for personal, family, or
            household purposes, you may ask us about the information we release
            to other organizations for their marketing purposes.
          </p>
          <p className="text-gray-700 mt-2">
            <strong>California Notice of Collection:</strong> In the past 12
            months, we have collected the following categories of personal
            information enumerated in the CCPA: identifiers, demographics,
            internet activity, geolocation data, customer records, commercial
            information, images, audio or video content.
          </p>
          <p className="text-gray-700 mt-2">
            <strong>Right to Know and Delete:</strong> You have rights to delete
            your personal information we collected and know certain information
            about our data practices in the preceding 12 months.
          </p>
          <p className="text-gray-700 mt-2">
            <strong>Shine the Light:</strong> You have the right to request
            information from us regarding the manner in which we share certain
            personal information as defined by applicable statute with third
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700">
            <strong>Data Controller / Data Processor:</strong> For the purposes
            covered by this Privacy Policy, we are a Data Controller with
            respect to the personal information you provide to us and remain
            compliant with our data controller obligations under GDPR.
          </p>
          <p className="text-gray-700 mt-2">
            <strong>Third-Party Provided Content:</strong> We may indirectly
            collect personal information about you from third-parties who have
            your permission to share it. For example, if you purchase a product
            or service from a business working with us, and give your permission
          ...
          <p className="text-gray-700 mt-2">
            ...
            We may also conduct marketing and market research activities,
            including how visitors use our site, website improvement
          ...
          <p className="text-gray-700 mt-2">
            ...
            identify you (“Anonymization”).
          </p>
        </section>
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-4">Right to Erasure</h2>
          <p className="mb-4">The right to erasure may apply when:</p>
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-4">Right to Portability</h2>
          <p className="mb-4">
            Individuals have the right to get some of their personal data from
            an organization in a way that is accessible and machine-readable,
            such as a CSV file. Additionally, individuals have the right to
            request the transfer of their personal data to another organization.
            However, the right to portability:
          </p>
          <ul className="list-disc list-inside ml-5">
            <li>
              Applies only to personal data which a person has directly given to
              Vibings Inc. in electronic form.
            </li>
            <li>
        ...
        <section className="mb-6">
          ...
          <p className="mb-4">
            ...
            individuals have the right to correct, update, or complete that
            data. This may involve filling gaps or adding supplementary
            statements. This right applies only to an individual&apos;s own
            personal data.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="mb-4">
            Upon discovery of a data breach, we will investigate the incident
            and report it to the UK&apos;s data protection regulator and you, if
            deemed appropriate.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="mb-4">
            ...
            data protection issues. We encourage you to contact us first to
            address your concerns before reaching out to the ICO.
          </p>
          <p className="mb-4">
            Contact Information:
            <br />
        ...
        <section className="mb-6">
          ...
          <p className="mb-4">
            Under PIPEDA, personal information includes financial information,
            views, opinions, and personal correspondences. Consent under PIPEDA
            is valid if it is reasonable to expect that an individual
            understands the nature, purpose, and consequences of the information
            collection.
          </p>
          <p className="mb-4">
            Contact Information for PIPEDA Compliance:
            <br />
